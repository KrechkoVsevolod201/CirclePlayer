...
- `MainActivity` owns permission prompts, folder-picker callback, preferences for theme/folder, and currently creates an ExoPlayer passed into Compose.
- `PlaybackService` separately creates another ExoPlayer. Verify ownership and state synchronization before implementing background playback or media controls.
