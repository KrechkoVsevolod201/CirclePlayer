...
- **Выбор треков и папок колесом** — списки показываются на мини-дисплее плеера и управляются Click Wheel
...
- **Светлая / тёмная тема** в настройках, выбор папки из медиатеки или системного проводника, shuffle и repeat (all / one)
